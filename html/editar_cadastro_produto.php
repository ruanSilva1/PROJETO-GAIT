...
<body>
    ...
    <input type="hidden" name="cod_produto" value="<?php echo $_GET['cod_produto'];?>">
        ...
        <div class="column-7">
            ...
            <textarea name="descricao" id="descricao" value="<?php echo $produtos['descricao']; ?>" minlength="1" maxlength="200" required></textarea>
        </div>
        <div class="column-8">
            <label for="observacao">observacao</label>
            <textarea name="observacao" id="observacao" value="<?php echo $produtos['observacoes']; ?>" maxlength="200" required></textarea>
        </div>
    </form>
